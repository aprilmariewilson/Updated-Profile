...
$(function () {
	...
	*/
	...
	$('.filter-button-group').on('change', 'input[type="radio"]', function() {
		...
		/* popup javaScript */
		$('.has-popup-javaScript').magnificPopup({
			type: 'image',
		...
		/* popup database */
		$('.has-popup-database').magnificPopup({
			disableOn: 700,
			type: 'image',
			removalDelay: 160,
			preloader: false,
	...
	*/
	...
	$('.has-popup-react').magnificPopup({
		...
		callbacks: {
			open: function() {
				$('.popup-box-image .popup-box').slimScroll({
					height: height+'px'
				});
			}
		}
